...
import (
	...
	"github.com/Go11Group/Javokhir-A/homework/lesson43/atto-app/billing-service/config"
	_ "github.com/lib/pq"
)
...
func CreateUrlForDatabseConnection(dbname string) string {
	...
	file, err := os.Open("/home/javokhir/go/src/github.com/Go11Group/Javokhir-A/homework/lesson43/atto-app/billing-service/resources/db_config.json")
	if err != nil {
