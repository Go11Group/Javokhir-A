...
type TranslatorServiceClient interface {
	Translator(ctx context.Context, in *TranslatingRequest, opts ...grpc.CallOption) (*TranslatingResponse, error)
}
...
func (c *translatorServiceClient) Translator(ctx context.Context, in *TranslatingRequest, opts ...grpc.CallOption) (*TranslatingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatingResponse)
	err := c.cc.Invoke(ctx, TranslatorService_Translator_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TranslatorServiceServer interface {
	Translator(context.Context, *TranslatingRequest) (*TranslatingResponse, error)
...
func (UnimplementedTranslatorServiceServer) Translator(context.Context, *TranslatingRequest) (*TranslatingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Translator not implemented")
}
...
func _TranslatorService_Translator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TranslatorServiceServer).Translator(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TranslatorService_Translator_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TranslatorServiceServer).Translator(ctx, req.(*TranslatingRequest))
	}
