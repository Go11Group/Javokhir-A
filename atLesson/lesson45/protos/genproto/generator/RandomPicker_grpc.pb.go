...
const (
	...
	Generator_GetNameBySurname_FullMethodName = "/protos.Generator/GetNameBySurname"
)
...
type GeneratorClient interface {
	...
	GetNameBySurname(ctx context.Context, in *UserName, opts ...grpc.CallOption) (*UserSurname, error)
}
...
func (c *generatorClient) GetNameBySurname(ctx context.Context, in *UserName, opts ...grpc.CallOption) (*UserSurname, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserSurname)
	err := c.cc.Invoke(ctx, Generator_GetNameBySurname_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GeneratorServer interface {
	...
	GetNameBySurname(context.Context, *UserName) (*UserSurname, error)
...
func (UnimplementedGeneratorServer) GetNameBySurname(context.Context, *UserName) (*UserSurname, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNameBySurname not implemented")
}
...
func _Generator_GetNameBySurname_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserName)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GeneratorServer).GetNameBySurname(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Generator_GetNameBySurname_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeneratorServer).GetNameBySurname(ctx, req.(*UserName))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Generator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNameBySurname",
			Handler:    _Generator_GetNameBySurname_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "Generator/RandomPicker.proto",
}
